...
const Aboutdata: datatype[] = [
    {
        ...
        country: "Hachtag Tracking",
        paragraph: 'Collect shared posts with tracked hashtags',

    },
    {
        imgSrc: "/assets/provide/graphic.svg",
        country: "Post Collection",
        paragraph: 'Retrieve posts containing specific hashtags',

    },
    {
        imgSrc: "/assets/provide/heaking.svg",
        country: "Notification",
        paragraph: 'Send notifications when new posts are shared ',
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 gap-8'>
                    ...
                    <div className='col-span-6 flex justify-center'>
                        <div className="flex flex-col align-middle justify-center p-10">
                            ...
                            <h4 className="text-lg pt-4 font-normal lh-33 text-center lg:text-start text-bluegray">Our application provides a seamless hashtag tracking experience on Twitter. Users can track specific hashtags, collect relevant posts, and receive timely notifications. Stay informed and engaged with the conversations that matter to you.</h4>
                        </div>
                    </div>
