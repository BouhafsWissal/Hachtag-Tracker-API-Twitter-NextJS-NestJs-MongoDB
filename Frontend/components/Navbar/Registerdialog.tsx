                    ...
                    <div>
                      ...
                      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                          <button
                            type="submit"
                            className="text-white font-medium text-sm py-2 px-4 border-transparent rounded-md justify-center w-full flex relative bg-blue-500 hover:bg-blue-600 focus:ring-blue-400 focus:outline-none focus:ring-2 focus:ring-opacity-50 text-center shadow-xl "
                          >
                            Register
                          </button>
                        </div>
